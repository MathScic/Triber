          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button key={label} type="button" onClick={() => setIsBuvette(value)}
                className={`flex items-center justify-center gap-2 h-11 rounded-xl border text-sm font-semibold transition-colors font-[family-name:var(--font-nunito)] ${isBuvette === value ? 'border-[#2A9D4E] bg-[#E8F5EE] text-[#2A9D4E]' : 'border-[#D1D1D6] text-[#6B7280] hover:border-[#2A9D4E]'}`}>
            ...
            <>
              ...
              <div>
                <button type="button"
                  ...
                  className="text-xs text-[#2A9D4E] font-semibold hover:opacity-80 transition-opacity font-[family-name:var(--font-nunito)]">
              ...
              <div>
                <label className="text-xs font-semibold text-[#6B7280] font-[family-name:var(--font-nunito)]">Date limite de règlement</label>
