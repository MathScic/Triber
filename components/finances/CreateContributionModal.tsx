          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button key={label} type="button" onClick={() => setIsBuvette(value)}
                className={`flex items-center justify-center gap-2 h-11 rounded-xl border text-sm font-semibold transition-colors font-[family-name:var(--font-nunito)] ${isBuvette === value ? 'border-success bg-primary-light text-success' : 'border-[#D1D1D6] text-[#6B7280] hover:border-success'}`}>
