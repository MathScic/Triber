  ...
  return (
    <div>
      ...
      <div
        ...
        className="w-full h-24 rounded-xl border-2 border-dashed border-[#D1D1D6] flex items-center justify-center cursor-pointer overflow-hidden hover:border-primary transition-colors bg-brand-bg"
      >
