  ...
  return (
    <div className="bg-white rounded-xl border border-[#D1D1D6] shadow-sm p-4 space-y-3">
      ...
      <p className="text-xs text-[#6B7280] italic font-[family-name:var(--font-nunito)]">
        Appuyer : ajouter → <span className="text-success font-semibold not-italic">T</span>itulaire →{' '}
        <span className="text-secondary font-semibold not-italic">R</span>emplaçant → retirer
      </p>
