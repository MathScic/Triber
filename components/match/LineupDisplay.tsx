...
function PlayerRow({ player }: { player: Player }) {
  ...
  return (
    <div className="flex items-center gap-2 py-1">
      <span className="w-6 text-right text-xs font-[800] text-[#7A8070] font-[family-name:var(--font-barlow)] tabular-nums flex-shrink-0">
        {player.jersey ?? '—'}
      </span>
...
export function LineupDisplay({ starters, subs }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#DDD8CE] shadow-sm p-4 space-y-4">
      ...
      {subs.length > 0 && (
        <div>
          <p className="text-xs font-semibold text-[#7A8070] mb-1 font-[family-name:var(--font-nunito)] uppercase tracking-wide">
